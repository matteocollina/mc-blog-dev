---
title: "Il software non si vende: si vendono soluzioni (e cambia tutto, anche per chi fa frontend)"
...
2. **Quanto costa oggi quel problema** (tempo, soldi, opportunità)
3. **Cosa cambia domani** se lo risolvi
...
1. **Problema**: cosa sta succedendo e per chi
2. **Impatto**: perché conta (metriche, costi, rischio)
3. **Soluzione**: cosa costruisci (in parole non tecniche)
4. **Misura**: come verifichi che ha funzionato
